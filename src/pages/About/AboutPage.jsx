...
/* Img */
import imgabout from '../../img/Gabriel.JPG';
          ...
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id='about-info-1'
                  defaultMessage="Hi, I'm Gabriel Mancilla. I consider myself a passionate individual about programming and web development. In 2022, I had the opportunity to enter the world of front-end and back-end development. I was able to create several projects using what I learned from the Academlo bootcamps and independently. From there, I developed a strong passion for web development. The ability to create incredible things using code fascinated me, and to this day, I continue to feel that same passion when working with code."
                />
              </p>
              ...
              <div className="hide parrafo-active">
                ...
                <p>
                  <FormattedMessage
                    id='about-info-3'
                    defaultMessage="I have experience working as a backend in No - Country, which gave me the opportunity to work on interesting projects, adapting to the technologies learned, which allowed me to improve my skills and knowledge; Additionally, I have also had the opportunity to be part of some online courses that helped me to enrich my skills and learn a little more about this beautiful world of web development."
                  />
                </p>
              </div>
