        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Gabriel Mancilla Ducuara and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                ...
                <ul>
                    ...
                    <li>
                        <p><span>Email:</span> gabrielmancilladucuara@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="postgresql" className="icons-skils" src="https://raw.githubusercontent.com/izumin5210/emojipack-for-devicon/master/png/postgresql.png" />
                        <h5>PostgresQL</h5>
                    </div>
                    <div>
                        <img alt="php" className="icons-skils" src="https://raw.githubusercontent.com/izumin5210/emojipack-for-devicon/master/png/java.png" />
                        <h5>Java</h5>
                    </div>
                </div>
                <h4>
